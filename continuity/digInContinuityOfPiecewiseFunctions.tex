...
\begin{align*}
  ...
  3 &= \answer[given]{a+b}.
\end{align*}
Hmmmm. At this point, we have 2 unknowns and only one equation.  That means we need to find another equation before we'll be able to solve for both unknowns.  Let's look for that other equation.  
