...
unknowns. However, be brave, intrepid mathematician: the definition of continuity will guide you to your goal.  To find $a$ and
...
\begin{align*}
  ...
  3 &= \answer[given]{a+b}.
\end{align*}
Hmmmm. At this point, we have 2 unknowns and only one equation.  That means we need to find another equation before we'll be able to solve for both unknowns.  Let's look for that other equation.  To find $a$ and $b$ that make $f$ is continuous at $x=3$, we need to
...
\[
 ...
 \]
 Let's check our answers.  By plugging in values for both $a$ and $b$ we find
 \[
 f(x) = 
 \begin{cases}
   x+4 &\text{if $x<1$,}\\
