...
\begin{problem}
  ...
  \begin{hint}
If you are struggling to determine $f(0)$, you may want to review how to evaluate functions using a graph \href{https://ximera.osu.edu/math160fa17/m160prerequisites/prerequisiteVideos/functionNotation}{here} or \href{https://ximera.osu.edu/math160fa17/m160prerequisites/understandingFunctions/digInForEachInputExactlyOneOutput}{here}.
  \end{hint}
