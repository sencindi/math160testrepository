...
\begin{problem}
  ...
  at $x$-values approaching (but not equal to) $2$, what happens to the value of $f(x)$?
    ...
    \begin{hint}
If you are struggling to determine what $f(x)$ approaches as $2$, you may want to review how to evaluate functions at\href{https://ximera.osu.edu/math160fa17/m160prerequisites/prerequisiteVideos/functionNotation}{here} or \href{https://ximera.osu.edu/math160fa17/m160prerequisites/understandingFunctions/digInForEachInputExactlyOneOutput}{here}.
  \end{hint}
