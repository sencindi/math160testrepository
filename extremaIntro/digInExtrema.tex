...
On its domain, the function $P(x)$ \wordChoice{\choice{is}\choice[correct]{is not}} continuous, and \wordChoice{\choice{does}\choice[correct]{does not}} have BOTH an absolute minimum and an absolute maximum.  
\end{exercise}
\end{exercise}
\end{exercise}
