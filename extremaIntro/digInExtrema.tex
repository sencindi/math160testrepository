...
On the  interval $\left( \answer{-\infty}, \answer{\infty} \right)$, the function $P(x)$ \wordChoice{\choice[correct]{is}\choice{is not}} continuous and \wordChoice{\choice{does not have any global extrema}\choice[correct]{has a global maximum but not a global minimum}\choice{has a global minimum but not a global maximum}\choice{has both a global minimum and a global maximum}}.
...
On $[-1,7]$, the function $y=f(x)$ \wordChoice{\choice{is}\choice[correct]{is not}} continuous and \wordChoice{\choice{does not have any global extrema}\choice{has a global maximum but not a global minimum}\choice[correct]{has a global minimum but not a global maximum}\choice{has both a global minimum and a global maximum}}.
\end{exercise}
\end{exercise}
\end{exercise}
...
On the \wordChoice{\choice{open}\choice[correct]{closed}} interval $\left[ \answer{-2}, \answer{7}\right]$, the function $g(x)$ \wordChoice{\choice{does not have any global extrema}\choice{has a global maximum but not a global minimum}\choice{has a global minimum but not a global maximum}\choice[correct]{has both a global minimum and a global maximum}}.
\end{exercise}
\end{exercise}
