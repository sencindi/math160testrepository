...
On the \wordChoice{\choice{open}\choice[correct]{closed}} interval $[] \answer{-2}, \answer{7}]$, the function $g(x)$ \wordChoice{\choice[correct]{is}\choice{is not}} continuous, and \wordChoice{\choice[correct]{does}\choice{does not}} have BOTH an absolute minimum and an absolute maximum. 
\end{exercise}
