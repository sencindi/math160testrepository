...
On the \wordChoice{\choice{open}\choice{closed}} interval $( \answer{-\infty}, \answer{\infty} )$, the function $P(x)$ \wordChoice{\choice[correct]{is}{is not}} continuous, and \wordChoice{\choice{does}\choice[correct]{does not}} have BOTH an absolute minimum and an absolute maximum.  
