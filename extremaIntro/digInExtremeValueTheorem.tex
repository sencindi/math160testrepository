...
This statement is \wordChoice{\choice{true}[correct]\choice{false}}.
...
\begin{feedback}[correct]
This statement is true!  In fact, this statement has the conditions we were looking for guarantee a function has both an absolute maximum and minimum.  Let's give this statement a name. 
\end{feedback}
\end{exercise}
