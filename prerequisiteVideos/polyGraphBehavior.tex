...
\begin{multicols}{3}
\begin{center}
A. \includegraphics[scale=0.25]{PolyBehaviorGraph1}
\end{center}

\begin{center}
B. \includegraphics[scale=0.25]{PolyBehaviorGraph2}
\end{center}
 
\begin{center}
C. \includegraphics[scale=0.25]{PolyBehaviorGraph3}
\end{center}
\end{multicols}

\begin{multicols}{3}
\begin{center}
D. \includegraphics[scale=0.25]{PolyBehaviorGraph4}
\end{center}

\begin{center}
E. \includegraphics[scale=0.25]{PolyBehaviorGraph5} %Correct One
\end{center}

\begin{center}
F. \includegraphics[scale=0.25]{PolyBehaviorGraph6}
\end{center}
\end{multicols}
