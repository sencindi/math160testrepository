...
\begin{multipleChoice}
\choice{A. \includegraphics[scale=0.25]{Graph1}}
\choice{B. \includegraphics[scale=0.25]{Graph2}}
\choice{C. \includegraphics[scale=0.25]{Graph3}}
\choice{D. \includegraphics[scale=0.25]{Graph4}}
\choice[correct]{E. \includegraphics[scale=0.25]{Graph5}}
\choice{F. \includegraphics[scale=0.25]{Graph6}}
\end{multipleChoice}
%% Example 2
\begin{flushright}
{\color{blue}(\emph{Click the arrow to the right to see an example.})}
...
\begin{multipleChoice}
\choice{$\frac{1}{7}x^2(x-2)(x-1)(x+1)^2(x+2)$}
\choice{$-\frac{1}{7}x^2(x-2)(x-1)(x+1)^2(x+2)$}
\choice{$\frac{1}{7}x(x-2)^2(x-1)^2(x+1)(x+2)^2$}
\choice[correct]{$-\frac{1}{7}x(x-2)^2(x-1)^2(x+1)(x+2)^2$}
\choice{$\frac{1}{7}x(x-2)^2(x-1)(x+1)^2(x+2)^2$}
\choice{$-\frac{1}{7}x(x-2)^2(x-1)(x+1)^2(x+2)^2$}
\end{multipleChoice}
%% Example 3
\begin{flushright}
