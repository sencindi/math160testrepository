...
\activity{PreRequisites/U1Functions/1.2PieceWiseFunctions/titlePage.tex}
\chapterstyle
%NXA: What are piece-wise Functions (See U2 for how to graph)

%% Composition of Functions
\activity{PreRequisites/U1Functions/1.3CompositionOfFunctions/titlePage.tex}
\chapterstyle
\activity{prerequisiteVideos/compositionOfFunction.tex}
\activity{understandingFunctions/digInCompositionOfFunctions.tex}

%% Inverses of Functions
\activity{PreRequisites/U1Functions/1.4InversesOfFunctions/titlePage.tex}
\chapterstyle
\activity{understandingFunctions/digInInversesOfFunctions.tex}

\part{Review of Notable Functions}
