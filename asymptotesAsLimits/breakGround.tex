...
In the first table, as the $x$ values got closer to $0$, $y = \frac{1}{x}$ \wordChoice{\choice[correct]{increased}\choice{decreased}}.

In the second table, as the $x$ values got closer to $0$, $y = \frac{1}{x}$ \wordChoice{\choice{increased}\choice[correct]{decreased}}.
