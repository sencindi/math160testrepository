...
In the first table, as the $x$ values became more positive, $y = \frac{1}{x}$ \wordChoice{\choice{increased}\choice[correct]{decreased}} toward $y = \answer{0}$.  

In the second table, as the $x$ values became more negative, $y = \frac{1}{x}$ \wordChoice{\choice[correct]{increased}\choice{decreased}} toward $y = \answer{0}$. 
