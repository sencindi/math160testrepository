...
In the first table, as the $x$ values got closer to $0$, $y = \frac{1}{x}$ \wordChoice{\choice[correct]{increased}\choice{decreased}}, and it appears that $\displaystyle\lim_{x \to 0^+} \frac{1}{x} = \answer{\infty}$.

In the second table, as the $x$ values got closer to $0$, $y = \frac{1}{x}$ \wordChoice{\choice{increased}\choice[correct]{decreased}}, and is appears that $\displaystyle\lim_{x \to 0^-} \frac{1}{x} = \answer{-\infty}$.
