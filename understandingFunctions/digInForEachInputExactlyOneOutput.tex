...
\begin{problem}
  Is the graph of the circle shown below the graph of a function?
  ...
  \begin{problem}
        Let's cut the previous circle in half.  Is the graph of the semi-circle shown below the graph of a function?
    ...
    \begin{feedback}[correct]
        Although the graph of a circle is not a function, the graph of the associated semi-circle is.  This semi-circle function is typically a \bf{branch} of the circle graph.
    \end{feedback}
  \end{problem}
\end{problem} 

Although the graph of a circle is not a function, the graph of the associated semi-circle is.  This semi-circle function is typically a \bf{branch} of the circle curve.  
