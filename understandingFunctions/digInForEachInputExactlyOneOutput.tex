...
\begin{problem}
  ...
  \includegraphics[scale=0.5]{functiondef1.png}
  ...
  \begin{problem}
        ...
        \includegraphics[scale=0.5]{functiondef2.png}
    ...
    \begin{feedback}[correct]
        Although the circle graph does not represent a function, the graph of the associated semi-circle is.  This semi-circle function is called a \bf{branch} of the circle graph.
    \end{feedback}
  \end{problem}
\end{problem} 
