...
\begin{problem}
  ...
  \begin{problem}
    ...
    \begin{feedback}[correct]
        Although the circle graph does not represent a function, the graph of the associated semi-circle is.  This semi-circle function is called a \textbf{branch} of the circle graph.
    \end{feedback}
  \end{problem}
\end{problem} 
