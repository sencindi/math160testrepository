...
\href{https://ximera.osu.edu/math160fa17/m160exam1content/indeterminateForms/digInLimitsOfTheFormZeroOverZero}{Previously, we have investigated} limits of the form \zeroOverZero.  Now we will investigate limits of the indeterminate form \numOverZero.  This will also turn out to be an indeterminate form. 
...
\begin{image}
	...
	\addplot [very thick, penColor, smooth,domain=-3:2] {1/(x+1)^2};
        \addplot [very thick, penColor, smooth,domain=-3:2] {1/(x+1)^2};
      \end{axis}
    \end{tikzpicture}
  \end{image}
