...
\begin{question}
    ...
    \begin{center} \includegraphics[scale=0.4]{TrigGraph.png} \end{center}
...
\begin{question}
    ...
    \begin{center} \includegraphics[scale = 0.4]{Triangle.png} \end{center}
...
\begin{problem}
    ...
    If $a, b,$ and $c$ represent the side lengths of the triangle below, find $a$ if $b = 3$, and $c = 8$.
