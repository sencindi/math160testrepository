...
\begin{problem}
    Choose all valid solutions in the first two quadrants to the trigonometric equation $2\cos(x) = \sqrt{3}$.
...
\begin{problem}
    Find the solutions to the equation $\sin(\theta) + \cos(\theta) = 0$.  (Choose all that are correct)
