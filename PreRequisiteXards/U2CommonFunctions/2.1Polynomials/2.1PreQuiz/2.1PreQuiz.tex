...
\begin{problem}
    ...
    \end{hint}
      ...
      \begin{multipleChoice}
          \choice{As x increases 2, y increases by 3}
          \choice{As x increases 3, y increases by 2}
          \choice{As x increases 1, y decreases $\frac{2}{3}$}
          \choice{As x increases 1, y increases $\frac{2}{3}$}
          \choice{As x decreases 2, y increases 3}
          \choice{As x decreases 2, y decreases 3}
          \choice{As x decreases 3, y increases 2}
          \choice{As x decreases 3, y increases 2}
