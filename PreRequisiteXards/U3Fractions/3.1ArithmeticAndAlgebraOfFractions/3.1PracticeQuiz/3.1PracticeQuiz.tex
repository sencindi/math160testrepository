...
\begin{problem} 
  ...
  \begin{selectAll}
      ...
      \choice[correct]{H. I drew pictures to get a geometric understanding of adding fractions.}
      \choice[correct]{I. I found a common denominator.}
      \choice[correct]{J. I used online resources to find the solutions.}
      \choice[correct]{K. I used online resources to remind me how to answer the questions, but then solved them myself.}
      \choice[correct]{L. I used a calculator to find the answers.}
      \choice[correct]{M. I used a calculator to check the solutions I found by hand.}
      \choice[correct]{N. I used strategies when completing the content quiz, but I don't remember the names of the strategies.}
      \choice[correct]{O. I used other strategies that aren’t listed here.}
      \choice[correct]{P. I didn't use any strategies when completing the content quiz.}
  \end{selectAll}
\end{problem}
