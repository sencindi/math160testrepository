...
\begin{problem} 
    What is $\frac{3}{4} + \frac{4}{3}$ equal to? (Mark all correct answer)
...
\begin{problem} 
  ...
  \begin{selectAll}
      ...
      \choice[correct]{I drew pictures to get a geometric understanding of adding fractions.}
      \choice[correct]{I found a common denominator.}
      ...
      \choice[correct]{I used a calculator to find the answers.}
      \choice[correct]{I used a calculator to check the solutions I found by hand.}
