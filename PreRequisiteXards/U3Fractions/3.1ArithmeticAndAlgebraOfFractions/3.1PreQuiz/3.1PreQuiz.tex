...
\vspace{1 in}
    ...
    K. I used strategies when completing the pre-quiz, but I don't remember the names of the strategies.
    ...
    M. I did not use any strategies when completing the pre-quiz.
