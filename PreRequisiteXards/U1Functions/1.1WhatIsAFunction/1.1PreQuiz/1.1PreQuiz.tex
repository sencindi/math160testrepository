...
\begin{problem}
    ...
    \begin{hint}
    If you are struggling to evaluate $f$ at $x=2$ using a graph, you may want to work through \href{https://ximera.osu.edu/math160fa17/m160prerequisites/prerequisiteVideos/functionsAndTheirGraphs}{this} card.
    \end{hint}
...
\begin{problem} 
    ...
    \begin{hint}
    If you are struggling to solve $f(x)=0$ using a graph, you may want to work through \href{https://ximera.osu.edu/math160fa17/m160prerequisites/prerequisiteVideos/functionsAndTheirGraphs}{this} card.
    \end{hint}
...
\begin{problem} 
    ...
    \begin{hint}
    If you are struggling to interpret what this function notation means, you may want to look at \href{https://ximera.osu.edu/math160fa17/m160prerequisites/prerequisiteVideos/functionNotation}{this} card.
    \end{hint}
...
\begin{problem} 
    ...
    \begin{hint}
    If you are struggling to interpret the solution of $g(x)=2$ represents, you may want to look at \href{https://ximera.osu.edu/math160fa17/m160prerequisites/prerequisiteVideos/functionNotation}{this} card.
    \end{hint}
