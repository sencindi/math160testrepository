...
\begin{problem} 
    ...
    \begin{hint}
    If you are struggling to interpret the solutions of $g(x)=2$, you may want to look at \href{https://ximera.osu.edu/math160fa17/m160prerequisites/prerequisiteVideos/functionNotation}{this} card.
    \end{hint}
