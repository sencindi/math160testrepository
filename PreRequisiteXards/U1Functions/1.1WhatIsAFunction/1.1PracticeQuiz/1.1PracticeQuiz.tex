...
\begin{problem} 
  ...
  \begin{selectAll}
      \choice[correct]{I answered the questions in order, assuming that the easier ones would \\ come first.}
      \choice[correct]{I answered the questions that I knew how to do first.}
      \choice[correct]{I read through all of the questions first before answering any.}
      \choice[correct]{After reading a question, I worked backwards and used process of elimination \\ to narrow down my options by checking if the answers were correct.}
      \choice[correct]{I used online resources to find the solutions.}
      \choice[correct]{I used online resources to remind me how to answer the questions, but then solved them myself.}
      \choice[correct]{I used strategies when completing the content quiz, but I don't remember the names of the strategies.}
      \choice[correct]{I used other strategies that aren’t listed here.}
      \choice[correct]{I didn't use any strategies when completing the content quiz.}
  \end{selectAll}
\end{problem}
