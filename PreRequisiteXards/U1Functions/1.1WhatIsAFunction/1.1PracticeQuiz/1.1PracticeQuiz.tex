...
\begin{center} \includegraphics[scale=0.7]{Graphing1.png} \end{center}
  ...
  If you didn't, why didn't you answer the question above?
  
  \begin{multipleChoice}
      \choice{I don't know the answer to this question yet.}
      \choice{I don't want to answer this question right now.}
      \choice{I have already answered this question correctly.}
  \end{multipleChoice}
\end{problem}
...
\begin{problem} 
  ...
  \begin{selectAll}
      ...
      \choice[correct]{H. I used other strategies that aren’t listed here.}
      \choice[correct]{I. I didn't use any strategies when completing the content quiz.}
  \end{selectAll}
\end{problem}
