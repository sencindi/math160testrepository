...
The function $f(x) = \frac{-1 + 2|x|}{x}$ has a vertical asymptote of $\answer{x} \ = \answer{0}$.  This function also has two vertical asymptotes: One below the $x$-axis, $\answer{y} = \answer{-2}$ and one above the $x$-axis, $\answer{y} = \answer{-2}{2}$.  
