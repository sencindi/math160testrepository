...
To evaluate the above limit, you had to multiply the numerator and denominator of $\frac{x^6 + 3.5x^3 -70x^2 + 2\pi}{3x - \frac{1}{3}x^3+ 4x^6}$ by $\cfrac{1}{x^{\answer{6}}}.$
