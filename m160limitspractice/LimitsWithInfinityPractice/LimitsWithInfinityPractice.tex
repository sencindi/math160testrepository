...
To evaluate the above limit, you had to multiply the numerator and denominator of $\frac{3x +7 - x^5}{x^4 + 8x^2 -3}$ by $1/x^{\answer{4}}.$
...
To evaluate the above limit, you had to multiply the numerator and denominator of $\frac{x^6 + 3.5x^3 -70x^2 + 2\pi}{3x - \frac{1}{3}x^3+ 4x^6}$ by $1/x^{\answer{6}}.$
