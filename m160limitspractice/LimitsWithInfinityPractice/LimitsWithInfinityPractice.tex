...
The function $f(x) = \frac{-1 + 2|x|}{x}$ has a vertical asymptote of $\answer{x} = \answer{0}$.  This function also has two vertical asymptotes: $\answer{y} = \answer{-2}{2}$ and $\answer{y} = \answer{-2}{2}$.
