...
\[ \displaystyle\lim_{x \to -\infty} \frac{5x^6 + 3.5x^3 -70x^2 + 2\pi}{3x - \frac{1}{3}x^3+ 6x^6} = \answer{-\infty} \]

\begin{exercise}

To evaluate the above limit, you had to multiply the numerator and denominator of $\frac{5x^6 + 3.5x^3 -70x^2 + 2\pi}{3x - \frac{1}{3}x^3+ 6x^6}$ by $\cfrac{1}{x^{\answer{\frac{5}{6}}}}.$
