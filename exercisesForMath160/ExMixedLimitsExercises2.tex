...
\begin{hint}
This is a limit that you may have seen before.  Alternatively, if you don't remember seeing this limit before, you can multiply by $\cos(x)+1$ in the numerator and denominator and then apply the Pythagorean identity to get started. 
\end{hint}
